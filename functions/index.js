...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    let mailOptions = {
      ...
      to: 'arc.development.transporter@gmail.com',
      subject: 'Message received', 
      html: `
        <p style="font-size:60px">${name}</p>
        <p style="font-size:60px">${email}</p>
        <p style="font-size:60px">${phone}</p>
        <p style="font-size:60px">${message}</p>`
    };
